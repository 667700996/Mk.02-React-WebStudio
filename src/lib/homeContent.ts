...
export const showreel = [
  {
    ...
    description: 'Executive narrative layer with structured data moments and controlled motion.',
  ...
  },
  {
    title: 'Product Prism',
    type: 'Product Layer',
    description: 'Guided onboarding, token-driven theming, and compliant motion governance.',
    metric: 'P95 LCP 0.9s',
  ...
  },
  {
    title: 'Launch Engine',
    type: 'Campaign Kit',
    description: 'Launch-ready system with press assets, OG automation, and release governance.',
  ...
  },
  {
    ...
    type: 'Knowledge',
    description: 'Knowledge surface with structured navigation and accessibility-first interaction.',
